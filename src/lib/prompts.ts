...
1. scoreJobFit: Evaluate alignment across Skills (35%), Experience (30%), Domain (20%), and Trajectory (15%).
2. tailorResume: Generate targeted resume bullet points emphasizing Cloudflare primitives (Workers, Durable Objects, Workflows, Pages, TypeScript).
3. generateInterviewPrep: Formulate technical and behavioral questions with structured STAR-method answers.
4. triggerBatchWorkflow: Dispatch a multi-step background Cloudflare Workflow for batch deep-tailoring.
